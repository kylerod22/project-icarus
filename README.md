...
## Data Access
NASA OMNIWeb was used to obtain historical solar-wind and magnetic-field measurements. The OMNI dataset combines measurements from multiple spacecraft and provides time-shifted solar-wind observations near Earth. Variables used in this project include magnetic-field measurements and solar-wind plasma parameters at hourly and higher temporal resolutions.
